...
function Footer() {
  return (
    <footer style={{backgroundColor:"rgb(240,240,240)",paddingBottom:"20px"}}>
      <div className="container  border-top" style={{ marginTop: "100px" }}>
        <div className="row mt-5">
          <div className="col">
            <img
              src="media/logo (2).svg"
              alt="i"
              style={{ width: "60%" }}
              className="mb-4"
            />
      ...
      <div className="mt-5">
          ...
          <ul style={{listStyle:"none", display:"flex", justifyContent:"center",gap:"15px"}} >
               ...
               <li>
                    <a href="#" style={{textDecoration:"none"}} className="text-muted">Terms & condition</a>
               </li>
               ...
               <li>
                    <a href="#" style={{textDecoration:"none"}} className="text-muted">For investor's</a>
               </li>


               <li>
                    <a href="#" style={{textDecoration:"none"}} className="text-muted">attention</a>
               </li>


               <li>
                    <a href="#" style={{textDecoration:"none"}} className="text-muted">Investor charter</a>
               </li>
          </ul>
      </div>
